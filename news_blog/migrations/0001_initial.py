    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(default='@gmail.com', max_length=254, verbose_name='Укажите вашу почту')),
                ...
                ('programmer_choices', models.CharField(choices=[('FULLSTACK', 'FULLSTACK'), ('BACKEND DEVELOPER', 'BACKEND DEVELOPER'), ('FRONT DEVELOPER', 'FRONT DEVELOPER'), ('UX-UI', 'UX-UI'), ('SYSTEM DEVELOPER', 'SYSTEM DEVELOPER')], max_length=100, verbose_name='Выберите категорию программиста')),
